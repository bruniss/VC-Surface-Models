...
if __name__ == "__main__":
    ...
    # 2. Prepare your data
    tiff_dir = "/models/normals/preprocess/tests/writing_normals/face_normals_continuous_new"
    ...
    # Output Zarr store
    zarr_out = "/home/sean/Documents/GitHub/VC-Surface-Models/models/normals/normals.zarr"
    with ProgressBar():
